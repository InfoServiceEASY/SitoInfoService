...
#endregion 
if(! is_null($aperto)){  
    $nome_colonne = array("Id", "Data Apertura", "Nome", "Oggetto");
    $total_pages = Table($nome_colonne,$pageno, $aperto);
...
?>    
    ...
    <a href="?pageno=<?php echo $total_pages."&aperto=".$num_aperto; ?>">    &gt;&gt;    </a> <!--</li> -->
</p>
</div>
<?php } 
else{?>
...
function Table($nome_colonne, $pageno,$aperto){
