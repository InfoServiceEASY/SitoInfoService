    ...
    <main class="page registration-page">
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form>
                    <div class="form-group"><label for="name">First Name</label><input class="form-control item" required type="text" id="name"></div>
                    <div class="form-group"><label for="password">Last Name</label><input class="form-control item" required type="password" id="password"></div>
                    <div class="form-group"><label for="email">Username</label><input class="form-control item" required type="email" id="email"></div>
                    <div class="form-group"><label for="email">Phone Number</label><input class="form-control item" required type="email" id="email-1"></div>
                    <div class="form-group"><label for="email">Email</label><input class="form-control item" required type="email" id="email-2"></div>
                    <div class="form-group"><label for="email">Password</label><input class="form-control item" required type="email" id="email-3"></div><button class="btn btn-primary btn-block" type="submit">Sign Up</button></form>
            </div>
        </section>
